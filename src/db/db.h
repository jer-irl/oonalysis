...
static inline auto get_storage(const std::string& filename) {
    ...
    auto storage = orm::make_storage(
            ...
            orm::make_table(
                    ...
                    orm::primary_key(&FunctionDecl::function_name, &FunctionDecl::file_path)
            ),
            orm::make_table(
                    "var_decls",
            ...
            orm::make_table(
                    ...
                    orm::primary_key(&FunctionDef::function_name)
            ),
            orm::make_table(
                    "func_calls",
                    orm::make_column("line_num", &FunctionCall::line_num),
                    orm::make_column("called_func_name", &FunctionCall::called_function_name),
                    orm::make_column("parent_func_name", &FunctionCall::parent_function_name),
                    orm::foreign_key(&FunctionCall::parent_function_name).references(&FunctionDef::function_name),
                    orm::primary_key(&FunctionCall::called_function_name,
